...
* **Carga de Modelo Serializado:** La aplicación utiliza `Microsoft.ML.OnnxRuntime.Gpu` para cargar los modelo `credit_score_model.onnx` y `loan_status_model.onnx` de forma adecuada.
...
* .NET 8.0 o superior.
* El paquete NuGet `Microsoft.ML.OnnxRuntime.Gpu`.

## 🚀 Instalación y Uso

1. **Clona el repositorio** en tu máquina local.
2. Abre la solución (`ONNXLoanApproval.sln`) en Visual Studio.
3. Asegúrate de que los archivos `credit_score_model.onnx` y `loan_status_model.onnx` se encuentren en la ruta esperada por el código o ajusta la ruta en el método `Form1_Load` (por defecto busca en `../../../model` relativo al ejecutable).
...
### Caso 1: Préstamo Aprobado (Resultado: 1 y Puntaje de credito: 639) 🟢
* **Age:** 22
* **Income:** 71948.00
* **Emp. Exp:** 0
...
### Caso 2: Préstamo Rechazado (Resultado: 0 y Puntaje de credito: 603) 🔴
* **Age:** 21
* **Income:** 12282.00
* **Emp. Exp:** 0
* **Loan Amount:** 1000.00
